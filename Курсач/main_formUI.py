...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sortByDescending_pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.sortByDescending_pushButton.setGeometry(QtCore.QRect(1400, 430, 201, 31))
        self.sortByDescending_pushButton.setObjectName("sortByDescending_pushButton")
        self.sortByAscending_pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.sortByAscending_pushButton.setGeometry(QtCore.QRect(1400, 390, 201, 31))
        self.sortByAscending_pushButton.setObjectName("sortByAscending_pushButton")
        self.findByCriteria_pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.findByCriteria_pushButton.setGeometry(QtCore.QRect(1400, 540, 201, 34))
        self.findByCriteria_pushButton.setObjectName("findByCriteria_pushButton")
        self.columns_comboBox = QtWidgets.QComboBox(self.centralwidget)
        self.columns_comboBox.setGeometry(QtCore.QRect(1400, 360, 201, 22))
        self.columns_comboBox.setObjectName("columns_comboBox")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(1400, 340, 201, 16))
        self.label_3.setObjectName("label_3")
        self.columnCriteria_textEdit = QtWidgets.QTextEdit(self.centralwidget)
        self.columnCriteria_textEdit.setGeometry(QtCore.QRect(1400, 500, 201, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sortByDescending_pushButton.setText(_translate("MainWindow", "Отсортировать по убыванию"))
        self.sortByAscending_pushButton.setText(_translate("MainWindow", "Отсортировать по возрастанию"))
